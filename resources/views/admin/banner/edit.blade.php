        ...
        <form class="layui-form layui-form-pane" action="{{route($config['update'],['id'=>$model->id])}}" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" autocomplete="off" placeholder="请输入标题名字" class="layui-input" name="name" value="{{$model->name}}">
                </div>
            </div>
            <div class="layui-form-item" >
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="checkbox"@if($model->status)checked="" @endif value="1" lay-text="正常|禁止" name="status" lay-skin="switch" lay-filter="switchTest" title="开关" >
                    </div>
                </div>
            </div>
            <div class="layui-form-item">
