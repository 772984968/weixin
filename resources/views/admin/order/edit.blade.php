            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" autocomplete="off" placeholder="请输入商品名字" class="layui-input" name="goods_name"
                           value="{{$model->goods_sn}}" disabled="disabled">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">订单归属人</label>
                <div class="layui-input-inline">
                    <input disabled  type="text" name="brand_id" placeholder="" autocomplete="off" class="layui-input" value="{{$model->user->name}}">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">订单状态</label>
                <div class="layui-input-inline">
                    <select name="order_status_id" lay-verify="required" lay-filter="sheng">

                        @foreach($status as $vo)
                            @if($vo->id==$model->order_status_id)
                                <option selected="selected"
                                        value="{{$vo->id}}">{{$vo->status}}</option>
                            @else
