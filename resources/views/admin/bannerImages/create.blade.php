        ...
        <form class="layui-form layui-form-pane" action="{{route($config['store'])}}" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" autocomplete="off" placeholder="请输入标题名字" class="layui-input" name="title" value="test">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" autocomplete="off" placeholder="请输入图片链接" class="layui-input" name="link" value="https://www.baidu.com/">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" autocomplete="off" placeholder="" class="layui-input" name="sort" value="0">
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-input-block">
