        ...
        <form class="layui-form layui-form-pane" action="{{route($config['store'])}}" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" autocomplete="off" placeholder="请输入商品名字" class="layui-input" name="goods_name" value="test">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="goods_number" id="date1" autocomplete="off" class="layui-input"  value="100">
                    </div>
                </div>
                <!--
                <div class="layui-inline">
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="shop_price" id="date1" autocomplete="off" class="layui-input"  value="100">
                    </div>
                </div>
                <div class="layui-inline">
                    <label class="layui-form-label">商场价格</label>
                    <div class="layui-input-inline">
                        <input type="text" name="market_price" autocomplete="off" class="layui-input" value="120">
                    </div>
                </div>
                <div class="layui-inline">
                    <label class="layui-form-label">促销价格</label>
                    <div class="layui-input-inline">
                        <input type="text" name="promote_price" autocomplete="off" class="layui-input" value="">
                    </div>
                </div>
            </div>
            ...
            <div class="layui-form-item" >
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="checkbox" checked="" value="1" lay-text="是|否" name="is_new" lay-skin="switch" lay-filter="switchTest" title="开关" >
                    </div>
                </div>
                <div class="layui-inline">
                    <label class="layui-form-label">是否促销</label>
                    <div class="layui-input-inline">
                        <input type="checkbox" checked="" value="1" lay-text="是|否" name="is_hot" lay-skin="switch" lay-filter="switchTest" title="开关" >
                    </div>
                </div>
                <div class="layui-inline">
                    <label class="layui-form-label">特价促销</label>
                    <div class="layui-input-inline">
                        <input type="checkbox" checked="" value="1" lay-text="是|否" name="is_promote" lay-skin="switch" lay-filter="switchTest" title="开关" >
                    </div>
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="checkbox" checked="" value="1" lay-text="是|否" name="is_on_sale" lay-skin="switch" lay-filter="switchTest" title="开关">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">发布时间</label>
                <div class="layui-input-inline">
                    <input name="created_at" type="text" class="layui-input" id="datetime" placeholder="请选择发布时间">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="goods_brief" autocomplete="off" placeholder="请输入商品的简短描述" class="layui-input" value=" this is goods brief">
                </div>
            </div>
