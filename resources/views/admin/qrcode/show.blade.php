            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <form class="layui-form layui-form-pane" action="{{route('qrcode.update',['id'=>$goods_id])}}" method="post">
                            {{ csrf_field() }}
                            <div class="layui-form-item">
                                <label class="layui-form-label">商品ID</label>
                                <div class="layui-input-inline">
                                    <input type="text" autocomplete="off" placeholder="" class="layui-input" name="goods_id"
                                           value="{{$goods_id}}" disabled>
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">商品地址</label>
                                <div class="layui-input-block">
                                    <input type="text" name="goods_url" placeholder="" autocomplete="off" class="layui-input" value="@if(isset($qrcode)){{$qrcode->goods_url}}@endif">
                                </div>
                            </div>
                            <div class="layui-form-item">
                            ...
                            <div class="layui-form-item">
                                <div class="layui-input-block">
                                    <img class="layui-upload-img" id="demo1" src="@if(isset($qrcode)) {{$qrcode->image}}@endif">
                                    <input name="goods_logo" type="hidden" value="">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <div class="layui-input-block">
        ...
        layui.use('upload', function () {
            ...
            var uploadInst = upload.render({
                ...
                , done: function (res) {
                    ...
                    $('input[name="goods_logo"]').val(res.src);
